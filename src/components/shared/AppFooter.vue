        ...
        socials: [
          {
            ...
            name: "GitHub",
            icon: "github",
            url: "https://github.com/miguel-ch",
          },
          {
            id: 2,
            name: "Linkedin",
            icon: "linkedin",
            url: "https://www.linkedin.com/in/miguel-ch",
          },
          {
            id: 3,
            name: "E-Mail",
            icon: "mail",
            url: "mailto:miguelchaparroripe8@gmail.com",
          },
        ],
      };
    },
  ...
  <div class="container mx-auto">
    <div class="pt-20 sm:pt-30 pb-8 mt-20 border-t-2 border-primary-light dark:border-secondary-dark">
      ...
      <div class="flex flex-col justify-center items-center mb-12 sm:mb-20">
        <p class="font-general-semibold text-3xl sm:text-4xl font-semibold text-primary-dark dark:text-primary-light mb-5">Social Media</p>
