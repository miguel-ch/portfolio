...
<template>
  <div class="w-full md:w-1/2">
    <div class="leading-loose max-w-xl m-4 p-7 bg-secondary-light dark:bg-secondary-dark rounded-xl shadow-xl text-left">
      ...
      <form action="https://formsubmit.co/miguelchaparroripe8@gmail.com" method="POST" class="font-general-regular space-y-7">
        <div>
          <input type="hidden" name="_subject" value="Portfolio Message" />
          <input type="hidden" name="_next" value="https://miguel-ch.github.io/portfolio/#/contact" />
